...
type BalanceLockRequest struct {
	...
	Id      string   `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`           // идентификатор блокировки (  опциональный параметр, если не указан - используется txID)
	Address string   `protobuf:"bytes,2,opt,name=address,proto3" json:"address,omitempty"` // адрес владельца
	Token   string   `protobuf:"bytes,3,opt,name=token,proto3" json:"token,omitempty"`     // идентификатор / тикер токена
	Amount  string   `protobuf:"bytes,4,opt,name=amount,proto3" json:"amount,omitempty"`   // big.Int количество токенов для блокировки
	Reason  string   `protobuf:"bytes,5,opt,name=reason,proto3" json:"reason,omitempty"`   // причина блокировки
	Docs    [][]byte `protobuf:"bytes,6,rep,name=docs,proto3" json:"docs,omitempty"`       // хэши документов с обоснованием (опциональный параметр)
	Payload []byte   `protobuf:"bytes,7,opt,name=payload,proto3" json:"payload,omitempty"` // дополнительная информация (опциональный параметр)
}
...
type TokenBalanceLock struct {
	...
	Address       string   `protobuf:"bytes,2,opt,name=address,proto3" json:"address,omitempty"`                                  // адрес владельца
	Token         string   `protobuf:"bytes,3,opt,name=token,proto3" json:"token,omitempty"`                                      // идентификатор / тикер токена
	InitAmount    string   `protobuf:"bytes,4,opt,name=init_amount,json=initAmount,proto3" json:"init_amount,omitempty"`          // big.Int первоначальное количество токенов для блокировки
	CurrentAmount string   `protobuf:"bytes,5,opt,name=current_amount,json=currentAmount,proto3" json:"current_amount,omitempty"` // big.Int текущее количество заблокированных токенов
	Reason        string   `protobuf:"bytes,6,opt,name=reason,proto3" json:"reason,omitempty"`                                    // причина блокировки
	Docs          [][]byte `protobuf:"bytes,7,rep,name=docs,proto3" json:"docs,omitempty"`                                        // хэши документов с обоснованием (опциональный параметр)
	Payload       []byte   `protobuf:"bytes,8,opt,name=payload,proto3" json:"payload,omitempty"`                                  // дополнительная информация (опциональный параметр)
}
...
type TokenBalanceLocked struct {
	...
	Id      string   `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`           // идентификатор блокировки
	Address string   `protobuf:"bytes,2,opt,name=address,proto3" json:"address,omitempty"` // адрес владельца
	Token   string   `protobuf:"bytes,3,opt,name=token,proto3" json:"token,omitempty"`     // идентификатор / тикер токена
	Amount  string   `protobuf:"bytes,4,opt,name=amount,proto3" json:"amount,omitempty"`   // big.Int количество токенов для блокировки
	Reason  string   `protobuf:"bytes,5,opt,name=reason,proto3" json:"reason,omitempty"`   // причина блокировки
...
type TokenBalanceUnlocked struct {
	...
	Address           string   `protobuf:"bytes,2,opt,name=address,proto3" json:"address,omitempty"`                                               // адрес владельца
	Token             string   `protobuf:"bytes,3,opt,name=token,proto3" json:"token,omitempty"`                                                   // идентификатор / тикер токена
	Amount            string   `protobuf:"bytes,4,opt,name=amount,proto3" json:"amount,omitempty"`                                                 // big.Int количество токенов для разблокировки
	Reason            string   `protobuf:"bytes,5,opt,name=reason,proto3" json:"reason,omitempty"`                                                 // причина блокировки
	Docs              [][]byte `protobuf:"bytes,6,rep,name=docs,proto3" json:"docs,omitempty"`                                                     // хэши документов с обоснованием (опциональный параметр)
	Payload           []byte   `protobuf:"bytes,7,opt,name=payload,proto3" json:"payload,omitempty"`                                               // дополнительная информация (опциональный параметр)
	CompleteOperation bool     `protobuf:"varint,8,opt,name=complete_operation,json=completeOperation,proto3" json:"complete_operation,omitempty"` // признак, что раблокировано полностью
}
